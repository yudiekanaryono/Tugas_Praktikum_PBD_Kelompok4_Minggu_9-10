...
crossorigin="anonymous">
  ...
  <a class="navbar-brand" href="#">Kelompok 4 Client</a>
  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href=" clientprodi.php">Data Prodi<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href=" clientuser.php">Data User<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href=" clientmahasiswa.php">Data Mahasiswa<span class="sr-only">(current)</span></a>
      </li>
    </ul>
